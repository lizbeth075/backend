...
export class UpdatePerformedCalculationDto {
  @ApiPropertyOptional({ example: 1, description: 'ID del usuario' })
  @IsOptional()
  @IsInt()
  user_id?: number;

  @ApiPropertyOptional({ example: '2024-06-26', description: 'Fecha del cálculo' })
  @IsOptional()
  @IsDateString()
  calculation_date?: Date;

  @ApiPropertyOptional({ example: 'liquidacion', description: 'Tipo de cálculo' })
  @IsOptional()
  @IsString()
